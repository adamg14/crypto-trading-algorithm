...
const calculateBollingerBands = require("./middleware/calculateBollingerBands");
...
app.post("/calculate-bollinger-bands", async(req, res) => {
  calculateBollingerBands(req, res);
});
